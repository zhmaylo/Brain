...
export const getSid = async (dispatch: any) => {
    let requestUrl: any, requestHeader: any;
    let json = await fetchData(requestUrl=URL_POST_AUTH, requestHeader=REQUEST_HEADER_AUTH()[0]);
